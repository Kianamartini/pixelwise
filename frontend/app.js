...
// The real drawing happens on a hidden 28x28 grid.
// The visible canvas is that grid magnified ten times,
// so the user paints at the model's own resolution.
...
pad.onmouseup = pad.onmouseleave = () => {
    drawing = false;
};
